...
func (c *controller) NewListOperation() *framework.PathOperation {
	return &framework.PathOperation{
		...
		Description: "Gets a list of all wallets optionally filtered by namespace",
...
func (c *controller) listHandler() framework.OperationFunc {
	return func(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
		...
		accounts, err := c.useCases.ListWallets().WithStorage(req.Storage).Execute(ctx, namespace)
		if err != nil {
